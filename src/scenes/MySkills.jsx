            ...
            <div className="md:flex md:justify-between md:gap-16 lgg:mt-16 mt-8 items-center">
                ...
                <div className=" md:flex md:justify-between mt-0 gap-48">
                    ...
                    visible: { opacity: 1, y: 0 }
                        ...
                        <div className="w-1/2 md:w-3/4 lg:h-24 h-16 bg-blue absolute right-0 top-0 z-[-1]" />
                    ...
                    visible: { opacity: 1, y: 0 }
                        ...
                        <div className="relative mb-16">
                            <div className=" z-10 ">
                                <p className=" font-playfair font-semibold lg:text-5xl text-3xl">03</p>
                                <p className=" font-playfair font-semibold lg:text-3xl text-xl">Data Analysis</p>
                            </div>
                        <div className="w-1/2 md:w-3/4 lg:h-24 h-16 bg-blue absolute right-0 top-0 z-[-1]" />
