    ...
    <section id="projects" className="lg:py-48 py-24 slo4">
      ...
      <div className="flex justify-center lg:mt-16 mt-8">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          variants={container}>
          <a href="https://mj-sneaker-store.vercel.app" target="_blank" rel="noreferrer"><Project title="Project 4" subtitle="An ecommerce website I designed for a shoe company. I used Next.js for handling the frontend and backend, tailwind for styling and responsiveness, sanity for content management allowing the owner to update their products without coding. ALso used stripe to handle payments and react hot toast and react icons." /></a>
